...
%
CROCO_title  = 'CROCO CEAZA HINDCAST';
CROCO_config = 'crococeazah';
%
% Grid dimensions:
%
...
%
grdname  = [CROCO_files_dir,'crococeazah_grd.nc'];
frcname  = [CROCO_files_dir,'crococeazah_frc.nc'];
blkname  = [CROCO_files_dir,'crococeazah_blk.nc'];
clmname  = [CROCO_files_dir,'crococeazah_clm.nc'];

bryname  = [CROCO_files_dir,'crococeazah_bry.nc'];
ininame  = [CROCO_files_dir,'crococeazah_ini.nc'];
bioname  = [CROCO_files_dir,'crococeazah_frcbio.nc']; % Iron Dust forcing for PISCES
rivname =  [CROCO_files_dir,'crococeazah_runoff.nc'];
%
% intermediate z-level data files (not used in simulations)
%
oaname   = [CROCO_files_dir,'crococeazah_oa.nc'];    % for climatology data processing
Zbryname = [CROCO_files_dir,'crococeazah_bry_Z.nc']; % for boundary data processing
%
% Generic forcing file root names for interannual simulations (NCEP/GFS)
%
frc_prefix=[CROCO_files_dir,'crococeazah_frc'];      % forcing file name 
blk_prefix=[CROCO_files_dir,'crococeazah_blk'];      % bulk file name
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
ERA5_offset = 485;                            % Days of ERA5 NRT to compute from the latest
...
%--------------------------
%
wkb_prefix=[CROCO_files_dir,'crococeazah_wkb'];
wkb_obc= [1 1 1 1];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
