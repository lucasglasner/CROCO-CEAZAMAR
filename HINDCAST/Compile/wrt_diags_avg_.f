     ...
     &                 / ltairgrd,lrhumgrd,lprategrd,lradlwgrd,lradswgrd
      ...
      real sin_phi(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real cos_phi(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real tan_phi(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
...
!$AGRIF_END_DO_NOT_TREAT
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (nciddia_avg, diaTime_avg, record,
     &                                              timedia_avg)
      if (ierr .ne. nf_noerr) then
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (nciddia_avg, diaTime2_avg, record,
     &                                              timedia_avg)
      if (ierr .ne. nf_noerr) then
