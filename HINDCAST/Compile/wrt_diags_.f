...
!$AGRIF_END_DO_NOT_TREAT
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (nciddia, diaTime, record, time)
      if (ierr .ne. nf_noerr) then
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (nciddia, diaTime2, record, time)
      if (ierr .ne. nf_noerr) then
